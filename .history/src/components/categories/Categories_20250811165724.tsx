          ...
          categories.map((category) => {
            return (
              <p
                ...
                className="block text-[#888] font-[raleway] text-[11px] leading-[16px] font-bold uppercase border-b-[1px] border-[#f7f7f7] bg-white pt-[15px] pr-[46px] pb-[15px] pl-[20px] cursor-pointer tra">
                {category.name}
              </p>
            );
          })}
