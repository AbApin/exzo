      ...
      <div className="flex items-center justify-between gap-[30px] md:gap-[50px]">
        ...
        <div className="flex items-center h-[42px] rounded-[21px] border-[1px] border-[#eee]">
          <span
            ...
            className="flex items-center justify-center text-black text-[20px] w-[50px] h-full border-r-[1px] border-[#eee] cursor-pointer rounded-[21px_0_0_21px] transition-all duration-150 ">
            -
          </span>
