...
function Cart({ cart }: Props) {
  ...
  return (
    <div className="flex flex-wrap md:flex-nowrap items-center justify-between py-[25px] px-[10px] border-b-[1px] border-[#eee]">
      ...
      <div className="flex items-center justify-between gap-[30px] lg:gap-[50px]">
        ...
        <button
          ...
          className="absolute md:static flex items-center justify-center border-0 bg-transparent cursor-pointer w-[40px] h-[40px] relative
    before:content-['']
    before:absolute
    before:left-0
    before:top-0
