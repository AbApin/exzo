...
function Cart({ cart }: Props) {
  ...
  return (
    <div className="flex flex-wrap md:flex-nowrap items-center justify-between py-[25px] px-[10px] border-b-[1px] border-[#eee] relative">
      <div className="flex items-center gap-[10px]">
        <div>
          <img
            src={thumbnail}
            className="block w-[150px] h-[150px] md:w-[85px] md:h-[85px] flex-shrink-0"
            alt={title}
          />
        </div>
        <p className="block font-[raleway] font-black text-[#343434] pr-[10px] lg:pr-0 text-[13px] leading-[18px] uppercase">
          {title}
        </p>
      </div>
      <div className="flex items-center justify-between gap-[30px] lg:gap-[50px]">
        ...
        <div className="flex items-center h-[42px] rounded-[21px] border-[1px] border-[#eee]">
          ...
          <span className="block text-[#888] text-[12px] text-center mx-[30px] lg:mx-[50px]">
            {count}
          </span>
          <span
        ...
        <button
          ...
          className="absolute right-[10px] right-[10px] md:static flex items-center justify-center border-0 bg-transparent cursor-pointer w-[40px] h-[40px]
    before:content-['']
    before:absolute
    before:left-0
    before:top-0
