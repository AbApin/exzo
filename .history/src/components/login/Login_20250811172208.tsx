    ...
    <div
      ...
      <div
        ...
        <button
          ...
          className="block w-full text-[#555] underline text-[11px] leading-[18px] text-center font-[raleway] uppercase font-bold relative cursor-pointer bg-transparent border-0 rounded-[26px] mt-[20px]">
          Register now
        </button>
      </div>
    </div>
