...
function Form({ label, handleClick, firebaseError }: FormProps) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <button
        type="submit"
        className="block w-full text-white text-[11px] leading-[18px] text-center font-[raleway] uppercase font-bold relative cursor-pointer bg-[#b8cd06] py-[15px] px-[30px] border-0 rounded-[]">
        {label}
      </button>
