  ...
  return (
    <div
      ...
      <div
        ...
        <button type="button" onClick={goToLogin}           className="block w-full text-[#555] underline text-[11px] leading-[18px] text-center font-[raleway] uppercase font-bold relative cursor-pointer bg-transparent border-0 mt-[20px]">
>
