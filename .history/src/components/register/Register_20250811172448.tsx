...
const Register = ({ onClose }: { onClose: () => void }) => {
  ...
  return (
    <div
      ...
      onClick={onClose}>
      <div
        className="inline-block w-full md:py-[80px] md:px-[100px]max-w-[570px] md:py-[80px] md:px-[100px] md:py-[80px] md:px-[100px] overflow-hidden relative bg-white rounded-[5px]"
