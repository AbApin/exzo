      ...
      <div
        className={
          haveInFavourites
            ...
            : 'flex items-center justify-center absolute r-[20px] top-[20px] border-[1px] border-[#555555] bg-tra hover:bg-[#b8cd06] rounded-[50%] cursor-pointer transition-all duration-300'
        }
