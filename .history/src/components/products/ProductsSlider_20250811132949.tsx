      ...
      <div className="sliderImgs">
        ...
        <Swiper
          ...
          {product &&
            product.images.map((img, i) => (
              <SwiperSlide
                className="flex items-center justify-center w-[100px] h-[100px] p-[10px] rounded-[50%] border-[1px] border-[#eee] cursor-pointer transition duration-300 bg:hover-[#b8cd06]"
                key={i}>
