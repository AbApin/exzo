...
const Product = ({ product }: { product: ProductType }) => {
  ...
  return (
    <div
      className={`flex flex-col  w-full  bg-white cursor-pointer border-[1px] border-[#f7f7f7] px-[30px] py-[25px] relative parent-group group ${
      ...
      <div
        ...
        <p className="text-[#343434] text-[13px] fo">{title}</p>
      </div>
      <div
        className={`${
