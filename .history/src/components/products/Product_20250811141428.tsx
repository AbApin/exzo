...
const Product = ({ product }: { product: ProductType }) => {
  ...
  return (
    <div className={showVersion === 'wrap' ? 'relative wrap group' : 'product column group'}>
      ...
      <div
        className={
          haveInFavourites
            ? '${
    isActive ? 'active' : ''
  }flex items-center justify-center absolute r-[20px] top-[20px] border-[1px] border-[#555555] bg-[#b8cd06] rounded-[50%] cursor-pointer transition-all duration-300'
