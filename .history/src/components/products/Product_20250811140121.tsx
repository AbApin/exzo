  ...
  return (
    <div className={showVersion === 'wrap' ? 'product wrap group' : 'product column group'}>
      ...
      <div className="w-[200px] h-[200px] mt-[10px] relative">
        ...
        <div className="hidden absolute top-0 left-0 w-full h-full items-center justify-center bg-[rgba(255,255,255,0.9)] animate-fadeIn transition-all duration-300">
