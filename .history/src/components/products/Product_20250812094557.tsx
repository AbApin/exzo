  ...
  return (
    <div
      ...
      <div
        ...
        } flex items-center justify-center absolute right-[20px] top-[20px] p border-[1px] border-[#555555] rounded-[50%] cursor-pointer hover:bg-[#b8cd06] transition-all duration-300 group child-group`}
