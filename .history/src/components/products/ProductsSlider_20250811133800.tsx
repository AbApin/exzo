      ...
      <div className="w-[40%]">
        ...
        <div className="flex items-center gap-[20px] mt-[20px]">
          ...
          <button
            ...
            className="inline-block text-white font-[raleway] text-center text-[11px] leading-[18px] font-bold rounded-[25px] shadow-[logout] uppercase bg-[#b8cd06] border px-[20px] py-[10px] cursor-pointer">
            Add to cart
          </button>
        </div>
      </div>
