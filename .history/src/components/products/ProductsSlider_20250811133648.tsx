      ...
      <div className="w-[40%]">
        ...
        <div className="flex items-center gap-[20px] mt-[20px]">
          <Link
            ...
            className="inline-block text-white font-[raleway] text-center text-[11px] leading-[18px] font-bold rounded-[25px] shadow-[logout] uppercase bg-[#343434] px-[10px] py-[20px]">
            Learn more
          </Link>
          <button
            type="button"
