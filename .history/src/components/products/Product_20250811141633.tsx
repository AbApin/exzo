  ...
  return (
    <div className={showVersion === 'wrap' ? 'relative wrap group' : 'product column group'}>
      ...
      <div
        ...
        } flex items-center justify-center absolute r-[20px] top-[20px]  border-[1px] border- rounded-[50%] cursor-pointer hover:bg-[#b8cd06] transition-all duration-300 group`}
