    ...
    <div className="flex flex-col mt-[30px]">
      {carts.length === 0 ? (
        <div className="flex items-center justify-center flex-col gap-[30px] h-[300px]">
          <p className="text-[25px] md:text-[40px] text-center italic tracking-[10px] w-full">
      ...
      {carts.length !== 0 && (
        <p className="text-black text-[18px] leading-[26px] font-bold capitalize mt-[30px]">
          cart total ` <span className="text-[#b8cd06]">${Number(cartsTotalPrice.toFixed(2))}</span>
        </p>
      )}
    </div>
  );
