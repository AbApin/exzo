...
const Register = ({ onClose }: { onClose: () => void }) => {
  ...
  return (
    <div
      className="fixed top-0 left-0 h-screen w-full bg-[rgba(0,0,0,0.5)] z-999 flex items-center justify-center px-[20px]"
      onClick={onClose}>
      <div
        className="inline-block w-full max-w-full md:max-w-[570px] py-[30px] px-[30px] md:py-[80px] md:px-[100px] overflow-hidden relative bg-white rounded-[5px]"
        onClick={(evt) => evt.stopPropagation()}>
        <h2 className="text-[25px] md:text-[30px] leading-[34px] text-[#343434] font-black text-center uppercase font-[raleway]">
          Register
        </h2>
